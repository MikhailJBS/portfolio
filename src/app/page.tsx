  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative py-32 md:py-40 overflow-hidden">
        {/* Background gradient */}
        <div className="absolute inset-0 bg-gradient-to-b from-purple-400/20 to-transparent opacity-40 pointer-events-none"></div>
        
        {/* Content */}
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl space-y-6">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
              Hi, I&rsquo;m <span className="text-purple-400">Mikhail</span>
            </h1>
        ...
        {/* Animated shape */}
        <div className="absolute -bottom-16 -right-16 w-64 h-64 bg-purple-400/10 rounded-full blur-3xl animate-pulse"></div>
      </section>
      ...
      <section id="skills" className="py-24 md:py-32">
        <div className="container mx-auto px-4 space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white/5 p-6 rounded-lg border border-white/10 hover:border-purple-400/50 transition-colors">
            ...
            <div className="grid md:grid-cols-5 gap-8">
              ...
              <div className="md:col-span-2 space-y-6">
                <div className="flex gap-4 items-start">
                  <div className="bg-purple-400/20 w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0">
