              ...
              <div className="flex flex-col gap-2 pt-4">
                {project.liveUrl && (
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-md bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-600 transition-colors"
                  >
