  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-12 h-12 bg-purple-400 rounded-full flex items-center justify-center shadow-lg z-50 hover:bg-purple-500 transition-colors active:scale-90 transition-transform"
